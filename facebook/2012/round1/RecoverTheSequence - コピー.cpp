...
void merge(int s0, int e0, int s1, int e1) {
	int head=s0;
	int wpos=0;
	//cout<<"Merge "<<s0<<" "<<e0<<" "<<s1<<" "<<e1<<endl;
	//REP(i, e0-s0) cout<<th[s0+i]<<" "; cout<<endl;
	//REP(i, e1-s1) cout<<th[s1+i]<<" "; cout<<endl;
	...
	//REP(i, wpos) cout<<th[head+i]<<" ("<<s0+i<<") "; cout<<endl;
}
